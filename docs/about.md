<div class="about-header">
  <img src="assets/profile.jpg?v=2" alt="Portrait of Dave" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Hi I'm Dave!</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">
  <a href="https://github.com/woo-dg" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://www.linkedin.com/in/dave-grewal/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:20youngcoders20@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I'm Dave Grewal, pursuing a double major in Computer Science and Mathematics.

Previously, I was a Software Engineer Intern at Hypernym AI (a Meta Llama startup). I built an internal benchmarking system that became the default way the team evaluated models and features.
